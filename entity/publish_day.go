...
type PublishDay struct {
	Id           uint   `gorm:"primaryKey;column:id;type:int(11);autoIncrement;not null"`
	Day          string `gorm:"column:day;type:varchar(10);unique;not null"`
	DisplayDay   string `gorm:"column:display_day;type:varchar(10);unique;not null"`
	DisplayOrder uint   `gorm:"column:display_order;type:int(11);null"`
